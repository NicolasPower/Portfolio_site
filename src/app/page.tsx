      ...
      <div className="flex flex-col justify-center items-center w-4/5 mx-auto ">
        ...
        <div className="w-full">
          ...
          <Element name="about" className="element">
            <div className="2xl:h-screen flex">
              <div className="flex flex-wrap pt-20">
                <div className="xl:w-1/2 lg:w-4/5">
                  {/* Header */}
                  <div className="">
                    <h1 className="mb-4 font-extrabold leading-none tracking-tight text-text text-5xl text-center lg:text-start">
                      About me
                    </h1>
                  ...
                  {/* Description */}      
                  <div className="flex flex-col mt-10 text-text md:text-center md:flex md:justify-center text-center lg:text-left">
                    ...
                    <p className="mb-2 text-lg">
                      ...
                      <span className="font-bold"> professional growth</span>. If you have a position that matches my skillset and experience, do
                  ...
                  {/* Skills */}
                  <h1 className="mb-4 font-extrabold leading-none tracking-tight text-text text-5xl text-center lg:text-start mt-5">Skills</h1>
                ...
                <div className="w-1/2 text-center hidden xl:block">
                  <img className="object-contain h-2/3 rounded-full xl:ml-16 2xl:ml-32 xl:my-20 2xl:my-12" src="/img/pfp.jpg" alt="Profile Picture"/>
                </div>
          ...
          <Element name="Projects" className="element">
            ...
            <div>
            <h1 className="mb-4 font-extrabold leading-none tracking-tight text-text text-5xl text-center lg:text-start mt-24">
                Projects
              </h1>
            </div>
            
            <div className="text-text flex flex-col lg:flex-row mt-20 items-center">
              ...
              <div className="lg:w-2/3 sm:w-4/5 flex flex-col text-center sm:items-center lg:text-start lg:ml-12 items-center lg:items-start">
                ...
                <a
                      ...
                      className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#CE5A67] rounded-lg hover:bg-[#ff7988] focus:ring-4 focus:outline-none focus:ring-blue-300 w-24"
                    >
                      Github
                      <svg
            ...
            <div className="text-text flex flex-col lg:flex-row mt-20 items-center">
              ...
              <div className="lg:w-2/3 sm:w-4/5 flex flex-col text-center sm:items-center lg:text-start lg:ml-12 items-center lg:items-start">
                ...
                <a
                      href="https://github.com/NicolasPower/Portfolio_site.git"
                      className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#CE5A67] rounded-lg hover:bg-[#ff7988] focus:ring-4 focus:outline-none focus:ring-blue-300 w-24"
                    >
                      Github
                      <svg
          ...
          <Element name="Contact" className="element">
            ...
            <section className="">
              <div className="py-8 pb-32 mx-auto max-w-screen-md">
                  <p className="mb-8 text-center text-text text-2xl">If you want to get in touch feel free to reach out to by contacting me on any of my socials!!</p>
                  <div className="flex flex-col items-start justify-around lg:pl-32">
                    
                    <div className="flex flex-col sm:flex-row my-3 items-center w-full">
                      <svg width="75px" height="75px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0)matrix(1, 0, 0, 1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.144"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M20 4C21.6569 4 23 5.34315 23 7V17C23 18.6569 21.6569 20 20 20H4C2.34315 20 1 18.6569 1 17V7C1 5.34315 2.34315 4 4 4H20ZM19.2529 6H4.74718L11.3804 11.2367C11.7437 11.5236 12.2563 11.5236 12.6197 11.2367L19.2529 6ZM3 7.1688V17C3 17.5523 3.44772 18 4 18H20C20.5523 18 21 17.5523 21 17V7.16882L13.8589 12.8065C12.769 13.667 11.231 13.667 10.1411 12.8065L3 7.1688Z" fill="#204969"></path> </g></svg>
                      <div className="flex flex-row text-start items-center px-8">
                        <p className="text-text font-bold text-md md:text-2xl">Nicolasrpower@gmail.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row my-3 items-center w-full">
                      ...
                      <div className="flex flex-row text-start items-center px-8 pt-3">
                        <p className="text-text font-bold text-md md:text-2xl">+61 0423 697 644</p>
                      </div>
                    </div>
                    ...
                    <svg width="75px" height="75px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6.5 8C7.32843 8 8 7.32843 8 6.5C8 5.67157 7.32843 5 6.5 5C5.67157 5 5 5.67157 5 6.5C5 7.32843 5.67157 8 6.5 8Z" fill="#204969"></path> <path d="M5 10C5 9.44772 5.44772 9 6 9H7C7.55228 9 8 9.44771 8 10V18C8 18.5523 7.55228 19 7 19H6C5.44772 19 5 18.5523 5 18V10Z" fill="#204969"></path> <path d="M11 19H12C12.5523 19 13 18.5523 13 18V13.5C13 12 16 11 16 13V18.0004C16 18.5527 16.4477 19 17 19H18C18.5523 19 19 18.5523 19 18V12C19 10 17.5 9 15.5 9C13.5 9 13 10.5 13 10.5V10C13 9.44771 12.5523 9 12 9H11C10.4477 9 10 9.44772 10 10V18C10 18.5523 10.4477 19 11 19Z" fill="#204969"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M20 1C21.6569 1 23 2.34315 23 4V20C23 21.6569 21.6569 23 20 23H4C2.34315 23 1 21.6569 1 20V4C1 2.34315 2.34315 1 4 1H20ZM20 3C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3H20Z" fill="#204969"></path> </g></svg>
                      <div className="flex flex-row text-start items-center px-8 pt-3">
                        <a className="text-text font-bold text-md md:text-2xl underline" href="https://www.linkedin.com/in/nicolas-power-31b217220" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                      </div>
                    </div>
